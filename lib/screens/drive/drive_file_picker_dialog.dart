...
/// Result returned by [DriveFilePickerDialog].
class DriveFileSelection {
  final String fileId;
  final String fileName;
  final String parentFolderId;
  /// Breadcrumb path, e.g. "My Drive › Projects › Patterns"
...
class DriveFilePickerDialog extends ConsumerStatefulWidget {
  ...
  static Future<DriveFileSelection?> show(BuildContext context) {
    return showDialog<DriveFileSelection>(
      context: context,
      builder: (_) => const DriveFilePickerDialog(),
    );
  }

  @override
  ConsumerState<DriveFilePickerDialog> createState() =>
      _DriveFilePickerDialogState();
}

class _DriveFilePickerDialogState
    extends ConsumerState<DriveFilePickerDialog> {
  ...
  void _selectFile(DrivePatternFile file) {
    ...
    Navigator.of(context).pop(DriveFileSelection(
      fileId: file.fileId,
