...
import '../../utils/controllers/canvas_callbacks.dart';
import '../../utils/controllers/canvas_edit_controller.dart';
...
import '../handlers/hover_handler.dart';
import '../handlers/zoom_pan_handler.dart';
                  ...
                  RepaintBoundary(
                    child: CustomPaint(
                      painter: CanvasStaticPainter(
                        ...
                        panOffset: _panOffset,
                        scale: _scale,
                        aidaColor: state.stitchMode ? const Color(0xFFFFFFFF) : state.pattern.aidaColor,
